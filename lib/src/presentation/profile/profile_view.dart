  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        verticalBox12,
        LuciText.titleSmall('Furkan', fontWeight: FontWeight.bold),
        verticalBox4,
        LuciText.bodyMedium('furkankazimc@gmail.com'),
        verticalBox16,
        const _EditButton(),
      ],
    );
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          verticalBox12,
          MyAccountSection(item: MyAccountEnum.security, onPressed: () {}),
          verticalBox12,
          MyAccountSection(
    ...
    return GestureDetector(
      ...
      child: DecoratedContainer(
        child: ListTile(
          ...
          leading: Icon(leading ?? item.icon, color: AppTheme.primaryColor),
